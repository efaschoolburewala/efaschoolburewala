...
export default function StaffAttendanceHistoryPage() {
    ...
    const [data, setData] = useState<{ staff: StaffHistory[]; working_dates: string[]; holidays?: Record<string, string> } | null>(null);
    ...
    const loadHistory = async () => {
        ...
        setLoading(true);
        try {
            const url = `${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/attendance/staff/history?month=${month}&year=${year}${deptId ? `&department_id=${deptId}` : ''}`;
