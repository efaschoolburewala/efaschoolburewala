...
export default function ResultsReportPage() {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/years`).then(r => r.json()).then(data => {
            setYears(data);
    ...
    useEffect(() => {
        ...
        setFilteredTerms([]);
        if (yearId) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/terms/${yearId}`)
                .then(r => r.json())
    ...
    const loadReport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/reports/results?${params}`);
