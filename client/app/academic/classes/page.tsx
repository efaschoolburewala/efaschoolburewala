...
export default function ClassSettings() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const url = editMode ? `${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/academic/${selectedId}` : `${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/academic`;
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/academic/${id}`, { method: 'DELETE' });
            if (res.ok) {
                fetchClasses();
