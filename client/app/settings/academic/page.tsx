...
export default function AcademicSetup() {
    ...
    const fetchTerms = async (yearId: number) => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/terms/${yearId}`);
            if (res.ok) {
    ...
    const fetchYears = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/years`);
    ...
    const handleConfigure = async (e: React.FormEvent) => {
        ...
        setSaveError(null);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/years/configure/${selectedYear.id}`, {
                method: 'PUT',
    ...
    const handleActivate = async () => {
        ...
        setSaveError(null);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/years/activate/${selectedYear.id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' }
            });
            if (!res.ok) {
    ...
    const handleSaveTerms = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-private-school.onrender.com"}/academic/terms`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
