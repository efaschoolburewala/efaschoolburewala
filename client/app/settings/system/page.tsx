...
export default function SystemConfigPage() {
    ...
    const fetchSettings = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system`);
            const data = await res.json();
            setSettings(data);
    ...
    const fetchStats = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system/db-stats`);
    ...
    const fetchBackups = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system/backups`);
            if (res.ok) {
                const data = await res.json();
                setBackups(data);
            }
    ...
    const handleDeleteBackup = async (filename: string) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system/backups/${filename}`, { method: 'DELETE' });
            if (res.ok) {
    ...
    const handleDownloadBackup = (filename: string) => {
        window.location.href = `${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system/backups/download/${filename}`;
    };
    ...
    const handleRestoreBackup = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/system/backups/restore`, {
                method: 'POST',
                body: formData
            });
            const data = await res.json();
