...
export default function ExpenseCategoriesPage() {
    ...
    const fetchCategories = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/expense-categories`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const url = editMode
                ? `${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/expense-categories/${currentCategory.category_id}`
                : `${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/expense-categories`;
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/expense-categories/${id}`, {
                method: 'DELETE'
            });
