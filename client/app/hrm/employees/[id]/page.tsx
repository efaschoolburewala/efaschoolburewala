...
export default function EmployeeProfile() {
    ...
    const fetchAttendance = async (m?: string, y?: string) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/attendance/staff/${id}/history?month=${month}&year=${year}`);
            if (res.ok) {
    ...
    const fetchEmployee = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/hrm/employees/${id}`);
            if (res.ok) {
    ...
    const toggleStatus = async () => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/hrm/employees/${id}/status`, {
                method: 'PATCH',
    ...
    const handleChangePassword = async () => {
        ...
        if (!newPwd) return;
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://efaschoolburewala.onrender.com"}/users/${employee.user_id}/password`, {
                method: 'PATCH',
                headers: { 'Content-Type': 'application/json' },
